...
const (
    ...
    //URL             = "https://sandbox.pagseguro.uol.com.br"                /*iury*/
    //CheckoutURL     = "https://ws.sandbox.pagseguro.uol.com.br/v2/checkout"     /* -> apiURL */
...
func (r *PaymentRequest) Submit() (result *PaymentPreSubmitResult) {
    ...
    /* OLD
        ...
        //response, _ := netClient.Get("https://renovelife.com/js/ga.js")
    */
